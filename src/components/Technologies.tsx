...
const technologies = [
    ...
    },
    {
        ...
        image: '/images/macadeflexodistracao.jfif',
        icon: (
            <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const electrotherapy = [
    {
        ...
        image: '/images/ultrassomterapeutico.jfif',
    },
    {
        title: 'Laser terapêutico',
        description: 'Estímulo à cicatrização e analgesia',
        image: '/images/laserterapeutico.jfif',
    },
];
