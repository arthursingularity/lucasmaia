                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 mb-8">
                            <p className="body-lg">
                                Sou fisioterapeuta <span className="font-medium">graduado</span> pela Universidade Norte do Paraná, com <span className="font-medium">pós-graduação</span> em Terapia Intensiva no Adulto, Fisioterapia Traumato-Ortopédica e Quiropraxia.
                            </p>
                            <p className="body-lg">
                                Atuo com foco no <span className="font-medium">tratamento das dores da coluna</span> e das disfunções musculoesqueléticas, utilizando uma abordagem individualizada e baseada em movimento.
                            </p>
                            <p className="body-lg">
